...
from utilities.testing.TowerTest import TowerTest
from utilities.testing.MenuTest import MenuTest
from utilities.testing.GameLoopTest import GameLoopTest
...
class Tester:
    ...
    def testTowerSelects(self, points):
        cordX = points["x"]
        cordY = points["y"]
